...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bienvenue. Ici vous pouvez g�rer vos donn�es stock�s dans diff�rents syst�me.\n"
				+ " Ce mini-programme en ligne de commandes va vous permettre d'ajouter, supprimer, modifier et voir les donn�es d'une base de donn�es et d'une Liste en m�moire.");
		System.out.println("Instructions d'utilisation :");
		System.out.println("Pour naviguer dans le programme, vous devez indiquer le num�ro du menu auquel vous souhaitez acc�der et appuyer sur entrer.");
		System.out.println();
				...
				do {
						...
						do {
							...
							if(readAboChoice == 1) { // Lire abonnement tout
								...
								do {
									...
									idClientAbo = scanInt();
									if(idClientAbo < 1) {
										System.out.println("ID Client doit �tre sup�rieur � 0.");
									}
								} while(idClientAbo < 1);
								...
								do {
									...
									idRevueAbo = scanInt();
									if(idRevueAbo < 1) {
										System.out.println("ID Revue doit �tre sup�rieur � 0.");
									}
								} while(idRevueAbo < 1);
								...
								try {
									...
									if(abos != null) {
										...
										System.out.println("Il n'existe pas d'abonnement pour cette cl�.");
									}
								...
								String dateDebut;
								do {
									System.out.print("Date de d�but d'abonnement (JJ/MM/AAAA) : ");
								...
								try {
									...
									if(!abos.isEmpty()) {
										...
										System.out.println("La liste \"Abonnement\" ne contient aucune donn�es pour cette date.");
									}
								} catch (Exception e) {
									System.out.println("ERREUR : " + e.getMessage());
									e.printStackTrace();
								...
								try {
									...
									if(!abos.isEmpty()) {
										...
										System.out.println("La liste \"Abonnement\" ne contient aucune donn�es pour cette date de fin.");
									}
								} catch (Exception e) {
									System.out.println("ERREUR :" + e.getMessage());
									e.printStackTrace();
					...
					case 2: // Ajouter abonnement
						do {
							...
							try {
								...
								if(abo != null) {
									System.out.println("Un abonnement existe d�j� pour cette cl� primaire. Merci de r�essayer.");
						...
						if(aboKeyValid) {
							try {
								...
								if(isCreated) {
									System.out.println("Ajout de l'abonnement r�ussi !");
								}
								else {
					...
					case 3: // Modifier un abonnement
						do {
							...
							try {
								...
								if(abo != null) {
									...
									System.out.println("L'abonnement que vous voulez modifier n'existe pas. Merci de r�essayer.");
									aboKeyValid = false;
								}
						...
						try {
							...
							if(isUpdated) System.out.println("Modification de l'abonnement r�ussi !");
					...
					case 4: // Supprimer un abonnement
						do {
							...
							try {
								...
								if(abo != null) {
									...
									System.out.println("L'abonnement que vous voulez supprimer n'existe pas. Merci de r�essayer.");
									aboKeyValid = false;
								}
						...
						try {
							...
							if(isDeleted) System.out.println("Suppresion de l'abonnement r�ussi !");
				...
				do {
					...
					case 1: // Lire client
						...
						do {
							...
							if(readClientChoice == 1) { // Lire tout
								try {
									...
									if(!clients.isEmpty()) {
										...
										System.out.println("\"Client\" ne contient aucune donn�es.");
									}
								} catch (Exception e) {
									System.out.println("ERREUR : " + e.getMessage());
									e.printStackTrace();
								...
								do {
									...
									idClient = scanInt();
									if(idClient < 1) {
										System.out.println("La cl� primaire doit �tre sup�rieur � 0.");
									}
								} while(idClient < 1);
								...
								try {
									...
									if(client != null) {
										...
										System.out.println("Il n'existe pas de client pour cette cl�.");
									}
							...
							else if(readClientChoice == 3) { // Lire en fonction du nom et du pr�nom
								...
								try {
									...
									if(!clients.isEmpty()) {
										...
										System.out.println("\"Client\" ne contient pas de donn�es pour ce nom et de pr�nom.");
									}
								} catch (Exception e) {
									System.out.println("ERREUR : " + e.getMessage());
									e.printStackTrace();
					...
					case 2: // Ajouter un client
						...
						try {
							...
							if(isCreated) System.out.println("Ajout d'un client r�ussit !");
					...
					case 3: // modifier un client
						do {
							...
							try {
								...
								if(client != null) {
									...
									System.out.println("Le client que vous voulez modifier n'existe pas. Merci de r�essayer.");
						...
						try {
							...
							if(isUpdated) System.out.println("Modification du client r�ussi !");
							else System.out.println("La modification du client a �chou�.");
						} catch (Exception e) {
							System.out.println("ERREUR : " + e.getMessage());
							e.printStackTrace();
						}
					...
					case 4: // Supprimer un client
						do {
							...
							try {
								...
								if(client != null) {
									...
									System.out.println("Le client que vous voulez supprimer n'existe pas. Merci de r�essayer.");
									clientKeyValid = false;
								}
						...
						try {
							...
							if(isDeleted) System.out.println("La suppresion du client a �t� effectu� avec succ�s !");
							else System.out.println("La suppresion du client a �chou�.");
						} catch (Exception e) {
							System.out.println("ERREUR : " + e.getMessage());
							e.printStackTrace();
						}
				...
				do {
							...
							if(readPeriodChoice == 1) { // Lire tout
								try {
									...
									if(!periods.isEmpty()) {
										...
										System.out.println("\"Periodicite\" ne contient aucune donn�es.");
									}
								} catch (Exception e) {
									System.out.println("ERREUR : " + e.getMessage());
									e.printStackTrace();
								...
								try {
									...
									if(period != null) {
										...
										System.out.println("Il n'existe pas de p�riode pour cette cl�.");
									}
					...
					case 2: // Ajouter une periodicite
						...
						try {
							...
							if(isCreated) System.out.println("Ajout r�ussi !");
						...
						repeat = false;
						break;
					case 3: // modifier une periodicit�
						do {
							do {
								System.out.print("ID : ");
								idPeriod = scanInt();
							...
							try {
								...
								if(period != null) {
									...
									System.out.println("La p�riode que vous voulez modifier n'existe pas. Merci de r�essayer.");
						...
						try {
							...
							if(isUpdated) System.out.println("Modification r�ussie !");
					...
					case 4:
						do {
							...
							try {
								...
								if(period != null) {
									...
									System.out.println("La p�riode que vous voulez supprimer n'existe pas. Merci de r�essayer.");
									periodKeyValid = false;
								}
						...
						try {
							...
							if(isDeleted) System.out.println("Suppresion r�ussi !");
				...
				do {
							...
							if(readRevueChoice == 1) { // Lire tout
								try {
									...
									if(!revues.isEmpty()) {
										...
										System.out.println("\"Revue\" ne contient aucune donn�es.");
									}
								} catch (Exception e) {
									System.out.println("ERREUR : " + e.getMessage());
									e.printStackTrace();
								...
								try {
									...
									if(revue != null) {
										...
										System.out.println("Il n'existe pas de revue pour cette cl�.");
									}
								} catch (Exception e) {
									System.out.println("ERREUR :" + e.getMessage());
									e.printStackTrace();
					...
					case 2: // ajouter une revue
						...
						try {
							...
							if(isCreated) System.out.println("Ajout d'une revue r�ussi !");
					...
					case 3: // modifier revue
						do {
							...
							try {
								...
								if(revue != null) {
									...
									System.out.println("La revue que vous voulez modifier n'existe pas. Merci de r�essayer.");
									revueKeyValid = false;
								}
						...
						try {
							...
							if(isUpdated) System.out.println("Modification d'une revue r�ussie !");
					...
					case 4: // Supprimer revue
						do {
							...
							try {
								...
								if(revue != null) {
									...
									System.out.println("La revue que vous voulez supprimer n'existe pas. Merci de r�essayer.");
									revueKeyValid = false;
								}
						...
						try {
							...
							if(isDeleted) System.out.println("Suppresion d'une revue r�ussi !");
	...
	public static int storageChoiceForm() {
		...
		System.out.println("1. Base de donn�e\n"
				+ "2. Liste en m�moire\n"
				+ "3. Quitter");
		System.out.print(">> ");
	...
	public static int optionChoice() {
		...
		System.out.println("1. Lire des donn�es\n"
	...
	public static int readAboChoice() {
		...
		System.out.println("1. Lire tout\n"
				...
				+ "3. Lire en fonction de \"Date d�but\"\n"
	...
	public static int readClientChoice() {
		...
		System.out.println("1. Lire tout\n"
				+ "2. Lire en fonction de l'ID\n"
				+ "3. Lire en fonction du nom et du pr�nom.");
		System.out.print(">> ");
	...
	public static Abonnement formAbonnement(boolean update) {
		...
		System.out.println("----------");
		if(update) {
			System.out.println("Veuillez indiquer les donn�es � modifier :");
			System.out.println();
		}
	...
	public static Periodicite formPeriod(boolean update) {
		...
		if(update) {
			System.out.println("Modification :");
			System.out.println("--------------");
			System.out.println("Veuillez indiquer les donn�es de la p�riodicit� � modifier.");
			System.out.println();
		}
	...
	public static Revue formRevue(boolean update) {
		...
		if(update) {
			System.out.println("Modification :");
			System.out.println("--------------");
			System.out.println("Veuillez indiquer les donn�es de la revue � modifier.");
			System.out.println();
		}
