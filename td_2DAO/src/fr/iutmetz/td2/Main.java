...
public class Main {
							...
							if(readAboChoice == 1) { // Lire abonnement tout
								...
								try {
									...
									if(abos != null) {
										...
										System.out.println("Il n'existe pas d'abonnement pour cette clé.");
									}
								...
								try {
									...
									if(!abos.isEmpty()) {
										...
										System.out.println("La liste \"Abonnement\" ne contient aucune données pour cette date de fin.");
									}
								} catch (Exception e) {
									System.out.println("ERREUR :" + e.getMessage());
									e.printStackTrace();
					...
					case 2: // Ajouter abonnement
						...
						if(aboKeyValid) {
							try {
								...
								if(isCreated) {
									System.out.println("Ajout de l'abonnement réussi !");
								}
								else {
						...
						do {
							...
							try {
								...
								if(abo != null) {
									...
									System.out.println("L'abonnement que vous voulez supprimer n'existe pas. Merci de réessayer.");
									aboKeyValid = false;
								}
	...
	public static Abonnement formAbonnement(boolean update) {
		...
		System.out.println("----------");
		if(update) {
			System.out.println("Veuillez indiquer les données à modifier :");
			System.out.println();
		}
