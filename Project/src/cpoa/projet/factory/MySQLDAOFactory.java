...
import cpoa.projet.dao.mysql.MySQLAbonnementBufferDAO;
...
import cpoa.projet.dao.mysql.MySQLRevueBufferDAO;
...
public class MySQLDAOFactory extends DAOFactory {
	...
	public RevueBufferDAO getRevueBufferDAO() {
		// TODO Auto-generated method stub
		return MySQLRevueBufferDAO.getInstance();
	}
	
	@Override
	public AbonnementBufferDAO getAbonnementBufferDAO() {
		return MySQLAbonnementBufferDAO.getInstance();
	}
}
